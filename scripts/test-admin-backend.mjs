...
createServer(async(req,res)=>{
 ...
 if(rpc==='admin_get_document_for_download')return body.p_kind==='resume'?send(`${id}/synthetic`):send({message:'Document unavailable'},400);
